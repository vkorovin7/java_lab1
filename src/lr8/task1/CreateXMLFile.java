...
public class CreateXMLFile {
    public static void main(String[] args) {
        try {
            ...
            author1.appendChild(doc.createTextNode("Федор Достоевский"));
            ...
            title2.appendChild(doc.createTextNode("Божественная комедия"));
            book2.appendChild(title2);

            Element author2 = doc.createElement("author");
            author2.appendChild(doc.createTextNode("Данте Алигьери"));
            book2.appendChild(author2);

            Element year2 = doc.createElement("year");
            year2.appendChild(doc.createTextNode("1321"));
